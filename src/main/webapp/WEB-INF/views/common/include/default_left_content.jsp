...
<div id="nav">
    <div id="nav-scroll">
        <div class="avatar-slide">
            ...
            <div class="avatar-link btn-group btn-group-justified" data-color="theme">
                ...
                <a class="btn" href="#contact-right" title="Contact List"><i class="fa fa-book"></i></a>
            </div>
            <!-- //avatar-link-->
                ...
                <div class="collapse-boby">
                    ...
                    <div class="widget-slider">
                        ...
                        <div class="progress progress-dark progress-xs tooltip-in">
                            <div class="progress-bar" data-color="#FA9E2F" aria-valuetransitiongoal="75"></div>
                        </div>
                        <label class="progress-label">Master.zip 4 / 5 </label>
                        <!-- //progress-->

                        <div class="progress progress-dark progress-xs">
                            <div class="progress-bar" data-color="theme-inverse" aria-valuetransitiongoal="45"></div>
                        </div>
